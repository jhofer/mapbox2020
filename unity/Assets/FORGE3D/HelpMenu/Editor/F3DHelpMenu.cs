...
namespace FORGE3D
{
    public class F3DHelpMenu
    {
        ...
        const string WebUrl = "http://www.forge3d.com";
        const string TwitterUrl = "https://twitter.com/Forge_3D";
        const string FacebookUrl = "http://facebook.com/forge3d";
        const string SupportUrl = "http://www.forge3d.com/contact/";
        const string DiscordUrl = "https://discord.gg/c9JQuDC";
        const string DocumentationUrl = "http://docs.forge3d.com/";
        const string BlogUrl = "http://www.forge3d.com/blog/";
